...
if __name__ == '__main__':
	#make sure each league's team_facts.csv file is up to date with metadata before running
	# main("NHL/NHL_2010-2021_season.csv", "NHL", nhl)
	# main("NBA/NBA_2010-2021_season.csv", "NBA", nba)
	# main("NFL/NFL_2010-2021_season.csv", "NFL", nfl)
	pass